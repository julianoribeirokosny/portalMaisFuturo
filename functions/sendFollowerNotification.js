    ...
    async (change, context) => {
      ...
      const payload = {
        notification: {
          ...
          body: `${displayName} está solicitando uma ação sua.`,
          icon: profilePic || '/images/icon-120x120.png',
          click_action: `https://portalmaisfuturo-teste.web.app/user/${followerUid}`,
        },
      };
