          ...
          <div class="mdl-card mdl-shadow--2dp mdl-cell
            ...
            <div class="fp-header">
              ...
              <ul class="fp-menu-list mdl-menu mdl-js-menu mdl-menu--bottom-right" for="fp-post-menu-${postId}">
                ...
                <li class="mdl-menu__item fp-delete-post"><i class="material-icons">delete</i> Excluir o post</li>
              </ul>
            </div>
    ...
    var config = {
      ...
      data: {
        datasets: [{
          ...
          borderWidth: 6,
          borderColor: '#FFFFFF', //transparente
          label: 'Dataset 1',
        }]
      },
      options: {
      ...
      const element = $(`
        <div id="comment-${escapedId}" class="fp-comment${isOwner ? ' fp-comment-owned' : ''}">
          ...
          <ul class="fp-menu-list mdl-menu mdl-js-menu mdl-menu--top-right" for="fp-comment-menu-${escapedId}">
            ...
            <li class="mdl-menu__item fp-delete-comment"><i class="material-icons">delete</i> Excluir comentário</li>
          </ul>
        </div>`);
